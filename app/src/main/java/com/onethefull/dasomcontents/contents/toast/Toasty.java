package com.onethefull.dasomcontents.contents.toast;
...
public class Toasty {
    ...
    public static Toast dasomCustom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(com.onethefull.dasomcontents.R.layout.toast_dasom, null);
        final TextView toastTextView = toastLayout.findViewById(com.onethefull.dasomcontents.R.id.text_desc);
